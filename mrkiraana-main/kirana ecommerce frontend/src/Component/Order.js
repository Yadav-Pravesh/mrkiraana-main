...
const handleRemoveOrder = async (orderId) => {
  ...
  return (
    <div className="d-flex">
      ...
      {/* Content Area */}
      <div className="content flex-grow-1 p-4" style={{ marginTop: "-50px",fontFamily:"roboto", }}>
        <div className="body-content px-4 py-4" style={{ backgroundColor: "#f1f5f9" }}>
          <div className="d-flex justify-content-between align-items-end flex-wrap">
            <div className="page-title mb-4">
              <Header />
              <h3 className="mb-0 text-start " style={{ fontWeight: "bold",marginLeft: "15px", }}> Orders</h3>
              <a
                onClick={() => navigate("/Dashboard")}
                style={{ cursor: "pointer", textDecoration: "none" }}
              >
                <h6 style={{ display: "inline", color: "black",marginLeft: "18px", opacity: 0.6, fontSize: "13px" }}>
                  Home
                </h6>
              </a>
          ...
          <div className="order-container " style={{ width: "100%", backgroundColor: "#f1f5f9", marginTop: "20px" }}>
              ...
              <div style={{ padding: "10px", marginTop: "20px", }}>
                ...
                >
                  <thead>
                    ...
                    >
                      <th style={{ textAlign: "left", whiteSpace: "nowrap",color:"blue" }}>ORDER NO</th>
                      <th style={{ textAlign: "left", paddingLeft: "0px",color:"blue" }}>CUSTOMER</th>
                      <th style={{ textAlign: "left", paddingLeft: "0px",color:"blue" }}>QTY</th>
                      <th style={{ textAlign: "left", paddingLeft: "0px",color:"blue" }}>TOTAL</th>
                      <th style={{ textAlign: "left", paddingLeft: "0px",color:"blue" }}>STATUS</th>
                      <th style={{ textAlign: "left", paddingLeft: "0px",color:"blue" }}>ACTION</th>
...
<td>
  ...
  <ul className="pagination">
    <li className="page-item">
      <button
        className="page-link"
        style={{ backgroundColor: "#f39c12", color: "#fff", border: "none" }}
    ...
    <li className="page-item">
      <button
        className="page-link"
        style={{ backgroundColor: "#2e62e6ff", color: "#fff", border: "none" }}
